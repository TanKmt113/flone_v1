...
- `<AdminMenuAdmin>` | `<admin-menu-admin>` (components/admin/MenuAdmin.vue)
- `<AdminProductDetail>` | `<admin-product-detail>` (components/admin/ProductDetail.vue)
- `<AdminTitle>` | `<admin-title>` (components/admin/Title.vue)
...
- `<HeroSliderBookStoreWrapper>` | `<hero-slider-book-store-wrapper>` (components/hero/HeroSliderBookStoreWrapper.vue)
