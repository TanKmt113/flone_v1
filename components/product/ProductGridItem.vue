  ...
  <div class="product-wrap mb-30">
    <div class="product-img">
      ...
      <div class="product-badges">
        ...
        <span class="product-label purple" v-if="product.discountPercentage"
    ...
    <div class="product-content text-center">
      ...
      <div class="product-rating" v-if="Math.floor(product.rating) == 4">
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o yellow"></i>
      ...
      <div class="product-rating" v-if="Math.floor(product.rating) == 3">
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o"></i>
      ...
      <div class="product-rating" v-if="Math.floor(product.rating) == 2">
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o"></i>
        <i class="fa fa-star-o"></i>
      ...
      <div class="product-rating" v-if="Math.floor(product.rating) == 1">
        <i class="fa fa-star-o yellow"></i>
        <i class="fa fa-star-o"></i>
        <i class="fa fa-star-o"></i>
        <i class="fa fa-star-o"></i>
