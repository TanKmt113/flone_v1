                  ...
                  <div class="col-6">
                    <div class="avatar-md bg-soft-primary rounded">
                      <i
                        ...
                        class="avatar-title fa fa-cart-plus fs-1"
                      ></i>
                    </div>
                  </div>
                  <!-- end col -->
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <div>
                    <span class="text-success">
                      <i class="bx bxs-up-arrow fs-12"></i> 2.3%</span
                    >
            ...
            <div class="card overflow-hidden">
              ...
              <div class="card-footer py-2 bg-light bg-opacity-50">
                <div class="d-flex align-items-center justify-content-between">
                  <div>
                    <span class="text-success">
                      <i class="bx bxs-up-arrow fs-12"></i> 8.1%</span
                    >
            ...
            <div class="card overflow-hidden">
              <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <div class="avatar-md bg-soft-primary rounded">
                      <i class="fa fa-archive avatar-title fs-1"></i>
                    </div>
                  </div>
                  <!-- end col -->
                  <div class="col-6 text-end">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <div>
                    <span class="text-danger">
                      <i class="bx bxs-down-arrow fs-12"></i> 0.3%</span
                    >
                    <span class="text-muted ms-1 fs-12">Last Month</span>
                  </div>
                  <a href="#!" class="text-reset fw-semibold fs-12">View More</a>
            ...
            <div class="card overflow-hidden">
              ...
              <div class="card-footer py-2 bg-light bg-opacity-50">
                <div class="d-flex align-items-center justify-content-between">
                  <div>
                    <span class="text-danger">
                      <i class="bx bxs-down-arrow fs-12"></i> 10.6%</span
                    >
                    <span class="text-muted ms-1 fs-12">Last Month</span>
                  </div>
                  <a href="#!" class="text-reset fw-semibold fs-12">View More</a>
          ...
          <div class="table-responsive">
            <table class="table table-hover table-nowrap table-centered m-0">
              ...
              <tbody>
                <tr>
                  <td class="ps-3">
                    <a href="#" class="text-muted">larkon/ecommerce.html</a>
                  </td>
                  <td>465</td>
                ...
                <tr>
                  <td class="ps-3">
                    <a href="#" class="text-muted">larkon/dashboard.html</a>
                  </td>
                  <td>426</td>
                ...
                <tr>
                  <td class="ps-3">
                    <a href="#" class="text-muted">larkon/chat.html</a>
                  </td>
                  <td>254</td>
                ...
                <tr>
                  <td class="ps-3">
                    <a href="#" class="text-muted">larkon/auth-login.html</a>
                  </td>
                  <td>3369</td>
                ...
                <tr>
                  <td class="ps-3">
                    <a href="#" class="text-muted">larkon/email.html</a>
                  </td>
                  <td>985</td>
                ...
                <tr>
                  <td class="ps-3">
                    <a href="#" class="text-muted">larkon/social.html</a>
                  </td>
                  <td>653</td>
                ...
                <tr>
                  <td class="ps-3">
                    <a href="#" class="text-muted">larkon/blog.html</a>
                  </td>
                  <td>478</td>
            ...
            <table class="table mb-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <img
                      src="https://techzaa.in/larkon/admin/assets/images/products/product-1(1).png"
                      alt="product-1(1)"
